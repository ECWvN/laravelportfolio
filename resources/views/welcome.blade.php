...
<body id="page-top">
  ...
  <nav class="navbar navbar-b navbar-trans navbar-expand-md fixed-top" id="mainNav">
    <div class="container">
      <a class="navbar-brand js-scroll" href="#page-top">EMMAVN</a>
  ...
  <!--/ Intro Skew Star /-->
  <div id="home" class="intro route bg-image" style="">
    <div class="overlay-itro"></div>
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">

          <p class="intro-subtitle  "><span class="text-slider-items">Emma van Nieuwburg, Webdevelopmet</span><strong class="text-slider"></strong></p>
            ...
            <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-7">
                    <div class="about-info">
                      <p><span class="title-s">Name: </span> <span>Emma van Nieuwburg</span></p>
                      <p><span class="title-s">Profile: </span> <span>webdeveloper</span></p>
                      <p><span class="title-s">Email: </span> <span>emmacwvn@gmail.com</span></p>
              ...
              <div class="col-md-6">
                <div class="about-me pt-4 pt-md-0">
                  ...
                  <p class="lead">
                    Hello, i am Emma van nieuwburg im a student webdeveloper from grafisch lyceum utrecht
                  </p>
                  <p class="lead">
